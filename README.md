...
Deployed Application (optional): [Flixster Deployed Site](https://flixster-cwg2.onrender.com/)
...
**Walkthrough video:** [Flixster Walkthrough](https://www.loom.com/share/15e63c2f2dc64215836a96ab56730fce)

### Reflection

* Did the topics discussed in your labs prepare you to complete the assignment? Be specific, which features in your weekly assignment did you feel unprepared to complete?

The labs gave me a solid foundation in React fundamentals — components, props, state with `useState`, and fetching data from an API with `useEffect`. These directly prepared me for displaying the movie grid, building the search bar, and managing favorites/watched state. The feature I felt least prepared for was wiring up the AI watch recommendation, since making a direct call to an external AI API and handling its loading/error states was something we hadn't practiced as much in lab.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.

With more time I would have refactored the state management to use Context (or a reducer) instead of passing favorites/watched state down through props, which would have made the sidebar pages cleaner. I'd also add pagination/infinite scroll to the search results and cache API responses to reduce redundant network requests.
...
- [The Movie Database (TMDb) API](https://developer.themoviedb.org/) — movie data source
